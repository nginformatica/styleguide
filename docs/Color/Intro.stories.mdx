...
###### `theme.colors.priority.(neutral|minimal|low|good|medium|high|critical|pink|purple|brown).(main|light)`
...
<ColorSample set='priority' token='good.main' />
<ColorSample set='priority' token='minimal.main' />
<ColorSample set='priority' token='neutral.main' />
<ColorSample set='priority' token='pink.main' />
<ColorSample set='priority' token='purple.main' />
<ColorSample set='priority' token='brown.main' />
...
<ColorSample set='priority' token='good.light' />
<ColorSample set='priority' token='minimal.light' />
<ColorSample set='priority' token='neutral.light' />
<ColorSample set='priority' token='pink.light' />
<ColorSample set='priority' token='purple.light' />
<ColorSample set='priority' token='brown.light' />
